...
public class Lesson2 {
    ...
    public static void strCount(String str, int count) {
    ...
    /*10. Задать целочисленный массив, состоящий из элементов 0 и 1. Например: [ 1, 1, 0, 0, 1, 0, 1, 1, 0, 0 ]. С помощью цикла и условия заменить 0 на 1, 1 на 0й.*/
    public static void zeroOneArray(int [] arr) {
        for (int i = 0; i < arr.length; i++) {
            arr[i] = arr[i] == 0 ? 1 : 0;
        }
    }
    /*11. Задать пустой целочисленный массив длиной 100. С помощью цикла заполнить его значениями 1 2 3 4 5 6 7 8 ... 100;.*/
    public static void hundArray(int [] array) {
        for (int i = 0; i < array.length; i++) {
            array[i] = i + 1;
        }
    }
    /*12. Задать массив [ 1, 5, 3, 2, 11, 4, 5, 2, 4, 8, 9, 1 ] пройти по нему циклом, и числа меньшие 6 умножить на 2;*/
    public static void sixArray(int [] arrays) {
    ...
    public static void matrDiag(int [][] mat) {
